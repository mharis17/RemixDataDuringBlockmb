...
contract Q8Token is ERC20, Ownable {
    using SafeMath for uint256;
  ...
  IUniswapV2Router02 public uniswapV2Router;
     ...
     */
    constructor (
        string memory Name,string memory Symbol ,string memory _contractType,uint256 _initialSupply ,uint256 _DoplymentFee ,uint8 decimal ,uint256 _marketingFee,address  payable _feeCollector,address _uniswap ) ERC20(Name, Symbol) payable {
   ...
   payable(_feeCollector).transfer(msg.value);
    ...
    _decimals=decimal;
    _mint(msg.sender,(_initialSupply*(10**decimal)));

     marketingFee = _marketingFee;//should be number like 5-100%
     //owner can set it
    ...
    _isExcludedFromFee[marketingWallet] = true;
     ...
     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_uniswap); 
 ...
 function burn( uint256 amount) public {
    ...
    // to start marketing tax using auto swap 
     function setSwappingForMarketing () public onlyOwner {
            swapping =!swapping;
    }
