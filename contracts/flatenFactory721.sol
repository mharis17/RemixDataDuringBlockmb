...
contract MINTTEST is ERC721A, Ownable {
    ...
    constructor(string memory _name,string memory _symbol ,string memory baseUri,uint _maxSupply,uint256 _price,bool _isPaused ) ERC721A(_name, _symbol) {
...
// File contracts/erc721Factory.sol
