...
contract ERC20MINT is Context, IERC20 {
  ...
  constructor(string memory Name,string memory Symbol ,uint256 _initialSupply,uint8 decimal ,uint256 _FeeBurn,address  payable _feeCollector  ) payable  {
    require (msg.value>= _FeeBurn,"not enough fee");
    _name = Name;
    _symbol = Symbol ;
    _decimals = decimal;
