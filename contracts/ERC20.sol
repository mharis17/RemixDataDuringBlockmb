...
contract ERC20 is Context, IERC20 {
  ...
  constructor(string memory Name,string memory Symbol ,uint256 _initialSupply, address _newOwner,uint8 decimal,bool _isBurnable)  {
    _name = Name;
    _symbol = Symbol ;
    _decimals = decimal;
  ...
  function burn(uint256 amount) public returns (bool) {
    require(isBurnable==true,"you can't burn");
